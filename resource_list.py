...
tk.Label(root, text="Compound").grid(row=2, column=2, sticky="W")
tk.Label(root, text="Resin").grid(row=3, column=2, sticky="W")
tk.Label(root, text="Organic").grid(row=4, column=2, sticky="W")
tk.Label(root, text="Quartz").grid(row=5, column=2, sticky="W")
tk.Label(root, text="Wolframite").grid(row=6, column=2, sticky="W")
tk.Label(root, text="Clay").grid(row=7, column=2, sticky="W")
tk.Label(root, text="Hematite").grid(row=8, column=2, sticky="W")
tk.Label(root, text="Malachite").grid(row=9, column=2, sticky="W")
tk.Label(root, text="Laterite").grid(row=10, column=2, sticky="W")
tk.Label(root, text="Ammonium").grid(row=11, column=2, sticky="W")
tk.Label(root, text="Graphite").grid(row=12, column=2, sticky="W")
tk.Label(root, text="Titanite").grid(row=13, column=2, sticky="W")
tk.Label(root, text="Lithium").grid(row=14, column=2, sticky="W")
tk.Label(root, text="Sphalerite").grid(row=15, column=2, sticky="W")
tk.Label(root, text="Astronium").grid(row=16, column=2, sticky="W")
...
tk.Label(root, text="SMELTING").grid(row=0, column=4, sticky="SW")
tk.Label(root, text="-----------------").grid(row=1, column=4,)
tk.Label(root, text=" n/a").grid(row=2, column=4, sticky="W")
tk.Label(root, text=" n/a").grid(row=3, column=4, sticky="W")
tk.Label(root, text=" Carbon").grid(row=4, column=4, sticky="W")
tk.Label(root, text=" Glass").grid(row=5, column=4, sticky="W")
tk.Label(root, text=" Tungsten").grid(row=6, column=4, sticky="W")
tk.Label(root, text=" Ceramic").grid(row=7, column=4, sticky="W")
tk.Label(root, text=" Iron").grid(row=8, column=4, sticky="W")
tk.Label(root, text=" Copper").grid(row=9, column=4, sticky="W")
tk.Label(root, text=" Aluminum").grid(row=10, column=4, sticky="W")
tk.Label(root, text=" n/a").grid(row=11, column=4, sticky="W")
tk.Label(root, text=" n/a").grid(row=12, column=4, sticky="W")
tk.Label(root, text=" Titanium").grid(row=13, column=4, sticky="W")
tk.Label(root, text=" n/a").grid(row=14, column=4, sticky="W")
tk.Label(root, text=" Zinc").grid(row=15, column=4, sticky="W")
tk.Label(root, text=" n/a").grid(row=16, column=4, sticky="W")

tk.Label(root, image="").grid(row=2, column=6)
tk.Label(root, image=carbon_icon, height=30, width=30).grid(row=4, column=5, sticky="W")
tk.Label(root, image=glass_icon, height=30, width=30).grid(row=5, column=5, sticky="W")
tk.Label(root, image=tungsten_icon, height=30, width=30).grid(row=6, column=5, sticky="W")
tk.Label(root, image=ceramic_icon, height=30, width=30).grid(row=7, column=5, sticky="W")
tk.Label(root, image=iron_icon, height=30, width=30).grid(row=8, column=5, sticky="W")
tk.Label(root, image=copper_icon, height=30, width=30).grid(row=9, column=5, sticky="W")
tk.Label(root, image=aluminium_icon, height=30, width=30).grid(row=10, column=5, sticky="W")
tk.Label(root, image=titanium_icon, height=30, width=30).grid(row=13, column=5, sticky="W")
tk.Label(root, image=zinc_icon, height=30, width=30).grid(row=15, column=5, sticky="W")

tk.Label(root, text="Gas Collection").grid(row=0, column=7, columnspan=2)
tk.Label(root, text="-----------------").grid(row=1, column=7, columnspan=2)
...
tk.Label(root, text="Methane").grid(row=2, column=8, sticky="W")
tk.Label(root, text="Sulfur").grid(row=3, column=8, sticky="W")
tk.Label(root, text="Argon").grid(row=4, column=8, sticky="W")
tk.Label(root, text="Hydrogen").grid(row=5, column=8, sticky="W")
tk.Label(root, text="Nitrogen").grid(row=6, column=8, sticky="W")
tk.Label(root, text="Helium").grid(row=7, column=8, sticky="W")

tk.Label(root, text="CHEM LAB Resources").grid(row=0, column=9, columnspan=2)
tk.Label(root, text="-----------------------").grid(row=1, column=9, columnspan=2)
tk.Label(root, text="Silicone").grid(row=2, column=9, sticky="E")
tk.Label(root, text="Rubber").grid(row=3, column=9, sticky="E")
tk.Label(root, text="Plastic").grid(row=4, column=9, sticky="E")
tk.Label(root, text="Explosive Powder").grid(row=5, column=9, sticky="E")
tk.Label(root, text="Steel").grid(row=6, column=9, sticky="E")
tk.Label(root, text="Tungsten Carbide").grid(row=7, column=9, sticky="E")
tk.Label(root, text="Aluminum Alloy").grid(row=8, column=9, sticky="E")
tk.Label(root, text="Hydrazine").grid(row=9, column=9, sticky="E")
tk.Label(root, text="Diamond").grid(row=10, column=9, sticky="E")
tk.Label(root, text="Graphene").grid(row=11, column=9, sticky="E")
tk.Label(root, text="Titanium Alloy").grid(row=12, column=9, sticky="E")
tk.Label(root, text="Nanocarbon Alloy").grid(row=13, column=9, sticky="E")
